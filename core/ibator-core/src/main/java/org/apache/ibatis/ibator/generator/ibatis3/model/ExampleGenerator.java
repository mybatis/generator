...
public class ExampleGenerator extends AbstractJavaGenerator {
    ...
    private InnerClass getCriteriaInnerClass(TopLevelClass topLevelClass) {
        ...
        answer.addJavaDocLine(" * This class was generated by Apache iBATIS Ibator."); //$NON-NLS-1$
        answer.addJavaDocLine(" * This class exists to make extending the example classes easier."); //$NON-NLS-1$
        answer.addJavaDocLine(" * You may add any custom where clause method to this class, and"); //$NON-NLS-1$
        answer.addJavaDocLine(" * the method will survive a Java merge (Ibator will never delete"); //$NON-NLS-1$
