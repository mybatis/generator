...
public class DefaultCommentGenerator implements CommentGenerator {
    ...
    public void addConfigurationProperties(Properties properties) {
        ...
        //addGeneratorComments
        addGeneratorComments = isTrue(properties
                .getProperty(PropertyRegistry.COMMENT_GENERATOR_ADD_GENERATOR_COMMENTS));
    ...
    public void addClassComment(InnerClass innerClass,
        ...
        if (!addGeneratorComments) return;
        StringBuilder sb = new StringBuilder();
    ...
    public void addModelClassComment(TopLevelClass topLevelClass,
            IntrospectedTable introspectedTable) {
        if (suppressAllComments  || (!addRemarkComments && !StringUtility.stringHasValue(author))) {
            return;
        }
