...
/**
 * This plugin adds REPLACE INTO methods to generated mapper interfaces.
 *
 * <p>The plugin generates methods for both single record and batch REPLACE operations,
 * which will delete and re-insert records if they already exist, or insert new ones if they don't.
 *
 * @author Goody
 */
