...
public class GeneralSelectDistinctExtensionFunctionGenerator extends AbstractKotlinMapperFunctionGenerator {
    ...
    public Optional<KotlinFunctionAndImports> generateFunctionAndImports() {
        ...
        imports.add("org.mybatis.dynamic.sql.util.kotlin.mybatis3.selectDistinct"); //$NON-NLS-1$

        KotlinFunction function = KotlinFunction.newOneLineFunction(mapperName + ".selectDistinct") //$NON-NLS-1$
