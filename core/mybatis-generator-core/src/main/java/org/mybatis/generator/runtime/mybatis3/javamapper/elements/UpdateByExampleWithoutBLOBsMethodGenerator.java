...
public class UpdateByExampleWithoutBLOBsMethodGenerator extends AbstractJavaMapperMethodGenerator {
    ...
    protected UpdateByExampleWithoutBLOBsMethodGenerator(Builder builder) {
        super(builder);
    }
    ...
    public boolean callPlugins(Method method, Interface interfaze) {
        return pluginAggregator.clientUpdateByExampleWithoutBLOBsMethodGenerated(method, interfaze, introspectedTable);
    }
    ...
    public static class Builder extends AbstractGeneratorBuilder<Builder> {
        ...
        public UpdateByExampleWithoutBLOBsMethodGenerator build() {
            return new UpdateByExampleWithoutBLOBsMethodGenerator(this);
        }
    }
}
