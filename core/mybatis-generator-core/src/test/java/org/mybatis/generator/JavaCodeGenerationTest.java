...
public class JavaCodeGenerationTest {
    ...
    private static List<GeneratedModelFile> generateJavaFilesMybatis() throws Exception {
        createDatabase();
        return generateModelFiles("/scripts/generatorConfig.xml");
    }

    private static List<GeneratedModelFile> generateJavaFilesMybatisDsql() throws Exception {
        createDatabase();
        return generateModelFiles("/scripts/generatorConfig_Dsql.xml");
    }

    private static List<GeneratedModelFile> generateModelFiles(String configFile) throws Exception {
