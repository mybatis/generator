...
public class JavaFileMergerTest {
    ...
    public void testThatFilesAreTheSameAfterMerge() throws Exception {
        ...
        String result = javaFileMerger.mergeJavaFile(newFile, new ByteArrayInputStream(oldFile.getBytes()), PUBLIC_CLASS_NAME, "UTF-8");
    ...
    private String createExistingFile() {
        ...
        existingUnit.addClass(PUBLIC_CLASS_NAME, Keyword.PUBLIC)
    ...
    public ConstructorDeclaration createConstructor(String publicClassName, boolean isGenerated) {
        ConstructorDeclaration constructorDeclaration = new ConstructorDeclaration(createModifierList(Keyword.PUBLIC), publicClassName);
        if (isGenerated) {
