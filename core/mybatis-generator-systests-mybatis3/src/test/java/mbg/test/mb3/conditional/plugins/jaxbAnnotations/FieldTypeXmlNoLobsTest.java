...
import mbg.test.mb3.generated.conditional.plugins.jaxbAnnotations.fieldType.noLobs.modelDto.*; //these are our mbg generated compiled model classes that we want to test.
import mbg.test.mb3.generated.conditional.plugins.jaxbAnnotations.fieldType.noLobs.clientMapperDao.*;
...
public class FieldTypeXmlNoLobsTest {
    ...
    public static void setUpBeforeClass() throws JAXBException, IOException, Exception {
        ...
        Reader reader = Resources.getResourceAsReader("mbg/test/mb3/conditional/MapperConfig.xml");
