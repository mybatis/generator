...
import mbg.test.mb3.generated.hierarchical.plugins.jaxbAnnotations.fieldType.withLobs.modelDto.*; //these are our mbg generated compiled model classes that we want to test.
import mbg.test.mb3.generated.hierarchical.plugins.jaxbAnnotations.fieldType.withLobs.clientMapperDao.*;
...
public class FieldTypeXmlWithLobsTest {
    ...
    public static void setUpBeforeClass() throws JAXBException, IOException, Exception {
        ...
        Reader reader = Resources.getResourceAsReader("mbg/test/mb3/hierarchical/MapperConfig.xml");
