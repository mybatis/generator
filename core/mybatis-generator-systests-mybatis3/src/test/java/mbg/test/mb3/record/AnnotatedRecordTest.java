...
import mbg.test.mb3.generated.record.annotated.mapper.FieldsblobsMapper;
import mbg.test.mb3.generated.record.annotated.mapper.FieldsonlyMapper;
import mbg.test.mb3.generated.record.annotated.mapper.PkblobsMapper;
import mbg.test.mb3.generated.record.annotated.mapper.PkfieldsblobsMapper;
import mbg.test.mb3.generated.record.annotated.mapper.PkfieldsMapper;
import mbg.test.mb3.generated.record.annotated.mapper.PkonlyMapper;
import mbg.test.mb3.generated.record.annotated.model.Pkfieldsblobs;
import mbg.test.mb3.generated.record.annotated.model.PkfieldsblobsExample;
...
class AnnotatedRecordTest {
    ...
    void testPKFieldsBlobsDeleteByPrimaryKey() {
        try (SqlSession session = sqlSessionFactory.openSession()) {
            ...
            long count = mapper.countByExample(new PkfieldsblobsExample());
            assertThat(count).isEqualTo(1);

            Pkfieldsblobs updateRecord = new Pkfieldsblobs(3, 4, "Betty", null, null);
            ...
            List<Pkfieldsblobs> records = mapper.selectByExampleWithBLOBs(new PkfieldsblobsExample());
            assertThat(records).isNotNull()
                    .hasSize(1);
            assertThat(blobsAreEqual(records.get(0).blob1(), expectedRecord.blob1())).isTrue();

            records = mapper.selectByExample(new PkfieldsblobsExample());
            assertThat(records).isNotNull()
                    .hasSize(1);
            assertThat(records.get(0).blob1()).isNull();
        }
    }
}
