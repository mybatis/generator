...
public class SuperClassExistenceChecker implements ExistenceChecker {

    @Override
    public boolean exists(MatcherSupport item, String matchString) {
        String superClass = item.getSuperClass();
        return matchString == null ? superClass == null : matchString.equals(superClass);
    }
}
