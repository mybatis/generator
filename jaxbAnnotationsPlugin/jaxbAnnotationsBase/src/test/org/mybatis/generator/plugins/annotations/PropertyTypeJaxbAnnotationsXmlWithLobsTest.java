...
import propertyType.withLobs.clientDao.*;
...
public class PropertyTypeJaxbAnnotationsXmlWithLobsTest
{
	...
	public void testRecordWithBlobsIsAnnotated() throws XPathExpressionException, JAXBException
	{
		...
		String clobNarrative = getValueFromXml(userTutorialWithBLOBs, "/userTutorialWithBLOBs/narrative");
		sb.delete(0, sb.length());

		String clobSummary = getValueFromXml(userTutorialWithBLOBs, "/userTutorialWithBLOBs/summary");
		sb.delete(0, sb.length());

		String base64Blob = getValueFromXml(userTutorialWithBLOBs, "/userTutorialWithBLOBs/video");
		...
		Assert.assertNotNull("Failure marshalling CLOB column narrative:", photoData);
	}
